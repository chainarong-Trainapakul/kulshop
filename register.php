...
<form method="post" action="login.php" enctype="multipart/form-data" name="frmAddUser" id="frmAddUser" onSubmit="return checkRegisterInfo();">
  ...
  <tr> 
   ...
   <td class=""> <input name="txtUserPhone" type="text" class="box" id="txtUserPhone" size="32" maxlength="10" value="<?php echo $tempPhone; ?>"></td>
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td class=""> <input name="txtUserPostalCode" type="text" class="box" id="txtUserPostalCode" size="32" maxlength="5" value="<?php echo $tempPostalCode; ?>"></td>
  </tr>
