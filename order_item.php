...
require_once 'process_qty_order.php';
...
$c_id = $_SESSION['plaincart_customer_id'];
$cartContent = getOrderItemContent($od_id);
...
<div class="panel panel-info">
  <div class="panel-heading">รายการใบเสร็จเลขที่ <?php echo $od_id?></div>
...
?>
 <tr class="content"> 
  <td align="center">
  	<span class="hidden-cat-product" id="productmini-<?php $od_id ; ?>" hidden></span>
      <img class="hidden-xs hidden-sm img-rounded" src="<?php echo $pd_thumbnail; ?>"weight="100" height="100" border="0"></td>
     <td><?php echo $pd_name ?></td>
     
     <td align="right"><?php echo $pd_price  ?></td>
     <td align="right"><?php echo $od_qty ?></td>
     <td align="right"><?php echo ($od_qty*$pd_price) ?></td>
 	<!--<a href="#" id="product-<?php /*echo $pd_id;*/ ?>" class="show-detail-product">-->
 	<!--<img class="hidden-xs hidden-sm img-rounded" src="<?php /*echo $pd_thumbnail*/; ?>"weight="100" height="100" border="0"></a>-->
  <td><a href="#" id="product-<?php echo $od_id; ?>" class="show-detail-product"><?php /*echo $pd_name;*/ ?></a></td>
  ...
  <div class="panel-body"> 
    <p align="center"> 
		<table border="0" align="center" cellpadding="10" cellspacing="0">
 			<tr align="center"> 
  				<td><input name="btnContinue" type="button" id="btnContinue" value="&lt;&lt; กลับ" onClick="window.location.href='<?php echo $shoppingReturnUrl; ?>';" class="btn btn-primary"></td>
				<td width="5%">&nbsp;</td>
				<?php 
				if ($numItem > 0) {
				?>  
