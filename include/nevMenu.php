...
?>	
	<p align="right">สวัสดี : <a href="<?php echo WEB_ROOT; ?>include/profile.php" class="leftnav"><?php echo $userFirstName; ?></a>&nbsp; | &nbsp;
...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>">ร้านชัยสิทธิ์เกษตร</a>
    </div>
...
<?php echo fetchCategoriesForNev(); ?>
        ...
        <li><a href="<?php echo WEB_ROOT.'detail.php'; ?>">รายการสั่งซื้อ</a></li>  
      ...
      <form class="navbar-form navbar-right" role="search">
        ...
        <button type="button" class="btn btn-default search-product" id="search-product-button" tabindex="2">ค้นหา</button>
      </form>
