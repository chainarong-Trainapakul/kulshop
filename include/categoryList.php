...
<div>
	...
	if ($numCategory > 0) {
		...
		// we have $url, $image, $name, $price
			...
			echo "<td width=\"$columnWidth%\" align=\"center\"><a href=\"#product-container\" class=\"category-group-item\" id=\"catname-$id\"><img class=\"img-rounded\" src=\"$image\"weight=\"100\" height=\"100\"  border=\"0\"><br>$name</a></td>\r\n";
