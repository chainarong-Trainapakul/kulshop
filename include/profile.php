...
<div class="panel panel-info" style="width:60%;margin-left:auto;margin-right:auto;">
	<div class="panel-heading">ข้อมูลส่วนตัว : <?php echo $user_first_name;?></div>
...
<form method="post" action="processProfile.php?profileKey=<?php echo $secretHash; ?>&action=edit" enctype="multipart/form-data" name="frmAddUser" id="frmAddUser" onSubmit="return checkRegisterInfo();">
 <table width="500" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
  <tr> 
   <td width="150" class="">ชื่อผู้ใช้</td>
  ...
  <tr> 
   ...
   <td class=""> <input name="txtUserPhone" type="text" class="box" id="txtUserPhone" size="32" maxlength="10" value="<?php echo $user_phone;?>" disabled="true"></td>
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td class=""> <input name="txtUserPostalCode" type="text" class="box" id="txtUserPostalCode" size="10" maxlength="5" value="<?php echo $user_postal_code;?>" disabled="true"></td>
  </tr>
  </table>
