...
<div class="panel panel-info" style="width:60%;margin-left:auto;margin-right:auto;">
	<div class="panel-heading">แก้ไขข้อมูลส่วนตัว : <?php echo $user_first_name; ?></div>
...
<form method="post" enctype="multipart/form-data" name="frmEditUser" id="frmEditUser">
 <table width="70%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
  ...
  <tr> 
   ...
   <td class=""> <input name="txtUserPhone" type="text" class="box" id="txtUserPhone" size="32" maxlength="10" value="<?php echo $user_phone;?>" ></td>
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td class=""> <input name="txtUserPostalCode" type="text" class="box" id="txtUserPostalCode" size="10" maxlength="5" value="<?php echo $user_postal_code;?>"></td>
  </tr>
        </form></div></div>
  </table>
