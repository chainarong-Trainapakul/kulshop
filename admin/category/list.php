...
<form action="processCategory.php?action=addCategory" method="post"  name="frmListCategory" id="frmListCategory">
 <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
  <tr align="center" id="listTableHeader"> 
   ...
   <td>คุณสมบัติ</td>
   <td width="75">รูปประเภทสินค้า</td>
   <td width="75">แก้ไข</td>
   <td width="75">ลบ</td>
  </tr>
  <?php
...
?>
  <tr class="<?php echo $class; ?>"> 
   ...
   <td width="75" align="center"><a href="javascript:modifyCategory(<?php echo $cat_id; ?>);">แก้ไข</a></td>
   <td width="75" align="center"><a href="javascript:deleteCategory(<?php echo $cat_id; ?>);">ลบ</a></td>
  </tr>
  <?php
  	} 		// สิ้นสุดลูป while
...
?>
  ...
  <tr> 
   <td colspan="5" align="right"> <input name="btnAddCategory" type="button" id="btnAddCategory" value="เพิ่มประเภทสินค้า" class="box" onClick="addCategory(<?php echo $catId; ?>)"> 
   </td>
  </tr>
 </table>
 <p>&nbsp;</p>
