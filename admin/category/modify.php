...
?>
    <br>
    <img src="<?php echo WEB_ROOT . CATEGORY_IMAGE_DIR . $cat_image; ?>"> &nbsp;&nbsp;<a href="javascript:deleteImage(<?php echo $cat_id; ?>);">ลบรูปภาพ</a> 
    <?php
	}
?>
   </td>
 ...
 <p align="center"> 
  <input name="btnModify" type="button" id="btnModify" value="บันทึกข้อมูล" onClick="checkCategoryForm();" class="box">
