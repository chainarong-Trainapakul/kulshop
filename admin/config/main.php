...
<form action="processConfig.php?action=modify" method="post" name="frmConfig" id="frmConfig">
 <table width="100%" border="0" cellspacing="1" cellpadding="2" class="entryTable">
  <tr id="entryTableHeader"> 
   <td colspan="2">ข้อมูลร้านค้า</td>
  </tr>
  <tr> 
   <td width="150" class="label">ชื่อร้าน</td>
  ...
  <tr> 
   ...
   <td class="content"><input name="txtPhone" type="text" class="box" id="txtPhone" value="<?php echo $sc_phone; ?>" size="30" maxlength="10"></td>
  </tr>
  <tr> 
