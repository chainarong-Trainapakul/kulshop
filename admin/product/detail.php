...
<form action="processProduct.php?action=addProduct" method="post" enctype="multipart/form-data" name="frmAddProduct" id="frmAddProduct">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  ...
  <tr> 
   <td width="150" height="36" class="label">ราคา</td>
  ...
  <tr> 
   ...
   <td class="content"><img src="<?php echo $pd_image; ?>"width="50" height ="50"></td>
  </tr>
 </table>
 <p align="center"> 
  <input name="btnModifyProduct" type="button" id="btnModifyProduct" value="แก้ไขสินค้า" onClick="window.location.href='index.php?view=modify&productId=<?php echo $productId; ?>';" class="box">
  &nbsp;&nbsp;
