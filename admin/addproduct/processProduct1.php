...
function addProduct()
{
    ...
    $name        = $_POST['txtName'];
    $in_renum     = $_POST['txtre']
    $warehouse    = $_POST['txtadd'];
    $date         = $_POST['txtUserTransfer']
	...
	$sql   = "INSERT INTO tb_instock (cat_id, pd_name, in_renum, warehouse, re_date)
	          VALUES ('$catId', '$name', '$in_renum', '$warehouse','$date', NOW())";
...
function modifyProduct()
{
   ...
   $add         = $_POST['txtadd'];
	...
	$sql   = "UPDATE tb_instock
	          SET cat_id = $catId, pd_name = '$name', in_renum,,= '$inrenum',  re_date = $day, 
			       warehouse = $add
