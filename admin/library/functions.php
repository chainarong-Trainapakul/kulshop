...
//	$sql = "UPDATE FROM tbl_product SET pd_qty = pd_qty+ $qty
//	        WHERE tbl_order.od_date < '$yesterday' AND tbl_order_item.pd_id == tbl_product.pd_id 
//            IN (SELECT tbl_order.od_date,tbl_order_item.pd_id FROM tbl_order,tbl_order_item)";
//	dbQuery($sql);	
//}
//    
